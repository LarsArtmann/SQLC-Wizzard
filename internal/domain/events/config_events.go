...
func (cued *ConfigurationUpdatedEventData) Data() map[string]interface{} {
...
func NewConfigurationUpdatedEventData(projectID, configurationID, updateReason, updatedBy string, updatedFields []string, oldValues, newValues map[string]interface{}) (*ConfigurationUpdatedEventData, error) {
